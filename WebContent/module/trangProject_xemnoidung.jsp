...
<%@page language="java" import="BusinessLogic.tbl_tt_projectBean"%>
...
<div class="details_highlights">
	...
	<div id="cactin_highlights">
		...
		<%		FunctionAll func = new  FunctionAll();
				...
				ArrayList<tbl_tt_project> list = bean.Project_XemNoiDungTinTheoMa(id_tintuc);
				if(list.size() > 0) {
					StringBuffer buf = new StringBuffer();
					buf.append("<div class='tieude_tintuc'>" + list.get(0).getName_project() + "");
