<?php
        ...
        // Preview options
        $mcImageManagerConfig['preview.wwwroot'] = 'C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/eventweb/uploads/'; // absolute or relative from this script path, try to leave blank system figures it out.
        $mcImageManagerConfig['preview.urlprefix'] = "{proto}://{host}/eventweb/uploads/"; // domain name
        ...
        $mcImageManagerConfig['filesystem.rootpath'] = 'C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/eventweb/uploads/'; // absolute or relative from this script path, required.
