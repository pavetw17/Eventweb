<?php
        ...
        $mcFileManagerConfig['preview.urlprefix'] = "{proto}://{host}/eventweb/uploads/"; // domain name
        ...
        $mcFileManagerConfig['filesystem.path'] = 'C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/eventweb/uploads/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = 'C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/eventweb/uploads/'; // absolute or relative from this script path.
