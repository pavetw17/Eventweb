<%@page import="BusinessLogic.FunctionAll"%>
...
<span ID="lblTK"
			style="font-weight: 700; color: blue; font-size: 16pt">Edit Page Events </span>
			
			
<!-- Events_SuaTin  -->
<form action="Events_SuaTin?action=ghivaoCSDL"  id="bangnhap" method="POST" enctype="multipart/form-data">
...
<table style="width: 100%;">
			<tr>
                ...
                <td width="83%" >
               <textarea id="txt_tenbai" name="txt_tenbai" style=" width: 400px;">${tbl_events.name_events}</textarea>
    		</tr>
    		<tr>
                <td width="17%" >
                ...
                <td width="1%"  align="center">
                    <font color="#FF0000"></font></td>
                <td width="83%" >
                 <textarea id="txt_tomtat"  name="txt_tomtat" style=" width: 400px;">${tbl_events.summary}</textarea>
                 </td>
    		</tr>
    		 <tr>	  
                ...
                <td width="83%" >
                    <c:if test="${not empty tbl_events.photo}">
  							<input type ="image" disabled src="${tbl_events.photo}" id="image_cu" name="image_cu" style=" width: 100px; height: 100px">
					</c:if>
					<input type="hidden" id="getid_tintuc" name="getid_tintuc" value="${tbl_events.id_events}">
                    <input type="hidden" id="txt_hinhanh_cu" name="txt_hinhanh_cu" value="${tbl_events.photo}" style="display: none" ></input>
    		...
    		<tr>	  
                ...
                <td width="1%"  align="right"><font color="#FF0000"></font></td>
                <td width="83%" >
                   <input type="text" id="dp_ngaybd" name="dp_ngaybd" value="${start_date_events}"/>
                   Start time: 
                   <input id="time_start" name="time_start" style="width: 55px" readonly value="${start_time}" />
                  </td>
            </tr>
    		<tr>	  
                ...
                <td width="1%"  align="right"><font color="#FF0000"></font></td>
                <td width="83%" >
                   <input type="text" id="dp_ngayketthuc" name="dp_ngayketthuc" value="${end_date_events}" />
                   End time: 
                   &nbsp<input id="time_end" name="time_end" style="width: 55px" readonly  value="${end_time}" />
                  </td>
            </tr>
            <tr>
                <td width="17%" >
                ...
                <td width="1%"  align="center">
                    <font color="#FF0000"></font></td>
                <td width="83%" >
                 <textarea id="txt_location"  name="txt_location" style=" width: 400px;">${tbl_events.location}</textarea>
                 </td>
    		</tr>
</table>
<br>

	<textarea name="div_text" id="div_text" style="margin-bottom: 10px; width: 1000px; height: 100%;">${tbl_events.contents}</textarea>
	<br>
