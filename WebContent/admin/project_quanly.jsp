...
$(document).ready(function(){
	  ...
	  $("#btn_themtin").click(function(){
		  window.location.href='showTinTuc?action=themProjects';
      });
...
<table style="width: 100%;">
	<tr>
		<td><span ID="lblTK"
			style="font-weight: 700; color: blue; font-size: 16pt">Projects Management</span></td>
	</tr>
	<tr>
...
<form >
	<table cellpadding="4" cellspacing="0" width="100%"
		...
		<tr>
			<td width="19%" align="right">Name Project:</td>
			<td width="2%">&nbsp;</td>
...
<input type="button" name="btn_themtin" value=" Add New Project " id="btn_themtin"
							class="button1"   style="  font-size: 12pt "/>
<br><br/>
