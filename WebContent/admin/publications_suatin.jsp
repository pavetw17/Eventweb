...
<!-- Publications_SuaTin -->
<form action="Publications_SuaTin?action=ghivaoCSDL"  id="bangnhap" method="POST" enctype="multipart/form-data">
...
<table style="width: 100%;">
	<tr>
               ...
               <textarea id="txt_tenbai" name="txt_tenbai" style=" width: 400px;">${tbl_pub.name_publication}</textarea>
    </tr>
    <tr>
                <td width="17%" >
                ...
                <td width="83%" >
                 ...
                 <textarea id="txt_tomtat"  name="txt_tomtat" style=" width: 400px;">${tbl_pub.summary}</textarea>
               		
               		
               		<input type="hidden" id="getid_tintuc" name="getid_tintuc" value="${tbl_pub.id_publication}">
                 </td>
    </tr>
...
<br>
	...
	<textarea name="div_text" id="div_text" style="margin-bottom: 10px; width: 1000px; height: 100%;"> ${tbl_pub.contents} </textarea>
	<br>
