  ...
  tinymce.init({
		...
		$.post( "/eventweb/temp", {
	       	action: 'truyentin',
				...
				/* if ($('#txt_tomtat').val() === '') {//lay id
					errorMessage += "Nhập tóm tắt.\n";
					valid = false;
				} */
				
				/* if ($('#txt_hinhanh').val() === '') {//lay id
					errorMessage += "Nhập hình ảnh.\n";
					valid = false;
				} // */
...
<span ID="lblTK"
			style="font-weight: 700; color: blue; font-size: 16pt">Add News Highlights</span>
<!-- Highlights_ThemTin -->
