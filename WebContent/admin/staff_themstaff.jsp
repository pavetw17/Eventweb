...
<!-- Staff_ThemStaff -->
<form action="Staff_AddStaff"  id="bangnhap" method="POST" enctype="multipart/form-data">
...
<table style="width: 100%;">
    		...
    		<tr>
                ...
                <td width="1%"  align="center">
                    <font color="#FF0000"></font></td>
                <td width="83%" >
                 <textarea id="txt_name"  name="txt_name" style=" width: 400px; height: 20px; " ></textarea>
                </td>
    		</tr>
    		<tr>
                <td width="17%" >
    		...
    		<tr>
                ...
                <td width="1%"  align="center">
                    <font color="#FF0000"></font></td>
                <td width="83%" >
                 <textarea id="txt_job" name="txt_job" style=" width: 400px; height: 20px; " ></textarea>
                 </td>
    		</tr>
    		<tr>
                <td width="17%" >
                ...
                <td width="1%"  align="center">
                    <font color="#FF0000"></font></td>
                <td width="83%" >
                 <textarea id="txt_task"  name="txt_task" style=" width: 400px; height: 45px; " ></textarea>
                </td>
    		</tr>
    		<tr>
                <td width="17%" >
                ...
                <td width="1%"  align="center">
                    <font color="#FF0000"></font></td>
                <td width="83%" >
                 <textarea id="txt_email"  name="txt_email" style=" width: 400px; height: 20px; " ></textarea>
                </td>
    		</tr>
