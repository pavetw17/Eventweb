...
<script type="text/javascript">
	...
	function pageselectCallback(page_index, jq){  //hien so trang len
     ...
     // var limit = Math.min((page_index+1) * items_per_page, bandau); //so dong
      ...
      $.post( "/eventweb/Publications_TimTin", {
      	action: 'list',
...
$(document).ready(function(){
	  ...
	  $("#btn_themtin").click(function(){
		  window.location.href='showTinTuc?action=themPublications';
      });
...
<table style="width: 100%;">
	<tr>
		<td><span ID="lblTK"
			style="font-weight: 700; color: blue; font-size: 16pt">Publications Management</span></td>
	</tr>
	<tr>
...
<form >
	<table cellpadding="4" cellspacing="0" width="100%"
		...
		<tr>
			<td width="19%" align="right">Name Publication:</td>
			<td width="2%">&nbsp;</td>
...
<input type="button" name="btn_themtin" value=" Add New Publication " id="btn_themtin"
							class="button1"   style="  font-size: 12pt "/>
<br><br/>
