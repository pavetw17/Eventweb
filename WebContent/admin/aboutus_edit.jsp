...
<script type="text/javascript">
  ...
  <br><br>
  <span ID="lblTK"	style="font-weight: 700; color: blue; font-size: 16pt">Edit Page About Us</span>
  <br> <br>
<!-- AboutUs_Edit -->
<form action="AboutUs_Edit"  id="bangnhap" method="POST" enctype="multipart/form-data">
	<input type="hidden" id="getid_aboutus" name="getid_aboutus" value="${tbl_aboutus.id}">
	<br><br>
	<textarea name="div_text" id="div_text" style="margin-bottom: 10px; width: 1000px; height: 100%;"> ${tbl_aboutus.contents} </textarea>
	<br>
