...
$(document).ready(function(){
	  ...
	  $("#btn_themtin").click(function(){
		  window.location.href='showTinTuc?action=themEvents';
      });
...
<table style="width: 100%;">
	<tr>
		<td><span ID="lblTK"
			style="font-weight: 700; color: blue; font-size: 16pt">Events Management</span></td>
	</tr>
	<tr>
...
<input type="button" name="btn_themtin" value=" Add Your Events " id="btn_themtin"
							class="button1"   style="  font-size: 12pt "/>
<br><br/>
