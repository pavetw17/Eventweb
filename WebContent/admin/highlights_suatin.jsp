...
<script type="text/javascript">
  ...
  <span ID="lblTK"
			style="font-weight: 700; color: blue; font-size: 16pt">Edit Page News </span>
<!-- Highlights_SuaTin -->
<form action="Highlights_SuaTin?action=ghivaoCSDL"  id="bangnhap" method="POST" enctype="multipart/form-data">
...
<table style="width: 100%;">
	<tr>
               ...
               <textarea id="txt_tenbai" name="txt_tenbai" style=" width: 400px;">${tb_news.name_news}</textarea>
    </tr>
    <tr>
                <td width="17%" >
                ...
                <td width="83%" >
                 ...
                 <textarea id="txt_tomtat"  name="txt_tomtat" style=" width: 400px;">${tb_news.summary}</textarea>
                 </td>
    </tr>
     <tr>	  
               ...
               <%-- <c:choose>
                ...
                <c:if test="${not empty tb_news.photo}">
  					<input type ="image" disabled src="${tb_news.photo}" id="image_cu" name="image_cu" style=" width: 100px; height: 100px">
				</c:if>
                
               		<input type="hidden" id="getid_tintuc" name="getid_tintuc" value="${tb_news.id_news}">
                    <input type="hidden" id="txt_hinhanh_cu" name="txt_hinhanh_cu" value="${tb_news.photo}" style="display: none" ></input>
...
<br>
	...
	<textarea name="div_text" id="div_text" style="margin-bottom: 10px; width: 1000px; height: 100%;"> ${tb_news.contents} </textarea>
	<br>
