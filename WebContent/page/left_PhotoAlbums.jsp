...
ddaccordion.init({
	...
	onopenclose:function(header, index, state, isuseractivated){ //custom code to run whenever a header is opened or closed
		...
		function pageselectCallback(page_index, jq){  //hien so trang len
		      ...
		      $.post( "/eventweb/Photo_AnhTheoGallery", {
		    	id_thumuc :  $("#get_id_thumuc").val(),
		      	offset: offset,
		  	    limit: limit,
		      	action: 'list'
		      }, function(newcontent){	 
		 	        $('#photo_gallery').html(newcontent);
		 	   	});        
		...
		$(document).ready(function() {
			$('.basic').click(function(e) {
			 	...
			 	$("#get_id_thumuc").val($(this).attr('href'));
			 	    /* alert($("#thang_nam").val()); */
				$.post("/eventweb/Photo_AnhTheoGallery", {
					id_thumuc : $(this).attr('href'),
				    action: 'getlength'
...
<%
	...
	String div_m = bean.Menu_LeftGallery(ds);
%>
...
%>
 ...
 <input type = "hidden" id="get_id_thumuc" name="get_id_thumuc">
</div>